		...
		<div>
			<div class="search-header">
				...
				<h1 class="search-header-title">
					<input type="text" name="keyword" v-model="value" class="search-header-input" autocomplete="off" placeholder="输入城市或景点" @focus="focus()" @input="input()"/>
...
<script>
	import HotList from '../../../search/components/HotList'
